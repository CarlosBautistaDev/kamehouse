  ...
  return (
    <main className="min-h-screen bg-bg-primary">
      ...
      <ParallaxSection
        ...
        imageAlt="Entrenamiento en acción en Kame House Training"
        overlay="dark"
      >
        <div className="max-w-3xl mx-auto text-center">
          <p className="font-heading text-4xl md:text-6xl text-white mb-4">
            TU MEJOR VERSIÓN EMPIEZA AQUÍ
          </p>
          <p className="text-white/60 mb-8 text-base md:text-lg">
            Entrena con los mejores. Resultados reales.
          </p>
          <Button
            href={`https://wa.me/${CONTACT.whatsapp}?text=${encodeURIComponent("Hola, quiero inscribirme en Kame House Training")}`}
            size="lg"
          >
            Inscríbete Ahora
          </Button>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg shadow-[#25D366]/30 hover:shadow-xl hover:scale-105 transition-transform duration-300 safe-bottom"
