    ...
    <section id="contacto" className="py-24 md:py-32 px-4 bg-bg-primary">
      <div className="max-w-5xl mx-auto">
        <AnimatedSection animation="blur-scale">
          ...
          <p className="text-text-secondary text-center text-lg mb-14">
          ...
          <AnimatedSection delay={200} animation="slide-left">
            <div className="flex flex-col gap-5 justify-center h-full">
              <div className="glass p-6">
                ...
                <p className="text-text-secondary pl-[52px]">{CONTACT.address}</p>
              </div>
              ...
              <Button
                ...
                size="lg"
                className="!bg-[#25D366] hover:!bg-[#20BD5A] shadow-lg shadow-[#25D366]/20 w-full justify-center text-white"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
              ...
              <a
                ...
                className="glass p-6 flex items-center gap-3 hover:-translate-y-0.5 transition-all duration-300"
              >
                <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] flex items-center justify-center shrink-0">
                ...
                <div>
                  <p className="font-semibold text-text-primary text-sm">Instagram</p>
                  <p className="text-text-secondary text-sm">{CONTACT.instagramHandle}</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <p className="font-semibold text-text-primary text-sm">Facebook</p>
                  <p className="text-text-secondary text-sm">{CONTACT.facebookHandle}</p>
                </div>
              </a>
            </div>
          </AnimatedSection>
